...
- Browser access stays inside an explicitly named Chrome or Aside profile. The configured and authenticated handles must match before collection.
- Managed Chrome profiles live under the selected data directory but their cookies and sessions are excluded from Social Memory backups.
