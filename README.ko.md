...
![선택한 SNS 반응을 로컬 자료실에 모으고, 연결된 AI가 근거를 검색해 답하는 흐름](assets/readme/workflow.ko.svg)
...
**같은 커넥터 안에서** 한 글에 좋아요와 북마크를 모두 남겨도 원문은 하나, 수집 기록은 두 개입니다. 나중에 북마크 수집을 끄더라도 과거 기록은 지워지지 않습니다. 같은 플랫폼을 여러 커넥터로 수집하면 원문이 중복될 수 있습니다.
